...
import { Calendar, Camera, Search, X, UserPlus, Bell, Clock } from 'lucide-react'
...
export default function TripFormModal({ isOpen, onClose, onSave, trip, onCoverUpdate }: TripFormModalProps) {
  ...
  useEffect(() => {
    if (trip) {
      ...
      setFormData({ title: '', description: '', start_date: '', end_date: '', currency: 'EUR', reminder_days: tripRemindersEnabled ? 3 : 0, schedule_margin_minutes: '0m', day_count: 7 })
