...
export const placesApi = {
  ...
  listImportedLists: (tripId: number | string) =>
      apiClient.get(`/trips/${tripId}/places/import/lists`).then(r => r.data),
  refreshImportedList: (tripId: number | string, id: number | string) =>
      apiClient.post(`/trips/${tripId}/places/import/lists/${id}/refresh`).then(r => r.data),
  deleteImportedList: (tripId: number | string, id: number | string) =>
      apiClient.delete(`/trips/${tripId}/places/import/lists/${id}`).then(r => r.data),
